...
class Gastos extends React.Component {
    ...
    fillTable = async (opcion, buscar) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/gasto/list', {
        ...
        ModalAlertDialog("Gasto", "¿Está seguro de que desea eliminar la transacción? Esta operación no se puede deshacer.", async (value) => {
            if (value) {
                try {
                    ...
                    let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+'/api/gasto/anular', {
                        params: {
                            "idGasto": idGasto,
                        }
                    })
