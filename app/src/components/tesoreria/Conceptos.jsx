...
class Conceptos extends React.Component {
    ...
    fillTable = async (opcion, buscar) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/concepto/list', {
    ...
    loadDataId = async (id) => {
        try {
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/concepto/id", {
        ...
        if (this.state.nombre === "") {
            ...
            try {
                ...
                if (this.state.idConcepto !== '') {
                    const result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/concepto/update', {
                    ...
                    const result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/concepto/add', {
                        "nombre": this.state.nombre.trim().toUpperCase(),
                        "tipo": this.state.tipo,
                        "codigo": this.state.codigo,
                        "idUsuario": this.state.idUsuario,
        ...
        ModalAlertDialog("Concepto", "¿Estás seguro de eliminar el concepto?", async (event) => {
            if (event) {
                try {
                    ...
                    let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+'/api/concepto', {
                        params: {
