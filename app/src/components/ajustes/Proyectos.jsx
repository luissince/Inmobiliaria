...
class Proyectos extends React.Component {
    ...
    fillTable = async (opcion, buscar) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/proyecto/list', {
        ...
        ModalAlertDialog("Proyecto", "¿Estás seguro de eliminar el proyecto?", async (event) => {
            if (event) {
                try {
                    ...
                    let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+'/api/proyecto', {
                        params: {
