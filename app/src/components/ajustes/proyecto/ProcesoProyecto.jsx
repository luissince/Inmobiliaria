...
class ProcesoProyecto extends React.Component {
    ...
    async loadData() {
        try {
            ...
            const sede = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/sede/listcombo", {
    ...
    async loadDataId(id) {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/proyecto/id", {
                signal: this.abortController.signal,
                params: {
                    idProyecto: id
                }
    ...
    async saveProject(image, extension) {
        if (this.state.idProyecto === "") {
            return await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/proyecto', {
                //datos
            ...
            return await axios.put(import.meta.env.VITE_APP_END_POINT+'/api/proyecto', {
                //datos
                "nombre": this.state.nombre.trim().toUpperCase(),
                "idSede": this.state.idSede.trim().toUpperCase(),
                "area": this.state.area.trim(),
