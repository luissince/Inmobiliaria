...
class Impuestos extends React.Component {
    ...
    fillTable = async (opcion, buscar) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/impuesto/list', {
    ...
    loadDataId = async (id) => {
        try {
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/impuesto/id", {
        ...
        if (this.state.nombre === "") {
            ...
            try {
                ...
                if (this.state.idImpuesto !== "") {
                    const result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/impuesto/edit', {
                    ...
                    const result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/impuesto/add', {
                        "nombre": this.state.nombre,
                        "porcentaje": this.state.porcentaje,
                        "codigo": this.state.codigo,
                        "estado": this.state.estado,
    ...
    onEventDelete(idImpuesto) {
        ModalAlertDialog("Impuesto", "¿Estás seguro de eliminar la moneda?", async (event) => {
            if (event) {
                try {
                    ModalAlertInfo("Impuesto", "Procesando información...")
                    let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+'/api/impuesto', {
                        params: {
