...
import { signOut, selectProject } from '../../redux/principalSlice';
...
class Principal extends React.Component {
    ...
    async componentDidMount() {
        try {
            ...
            let result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/proyecto/inicio", {
    ...
    onEventFocused = (event) => {
        ...
        if (userToken === null) {
            ...
            if (projectToken !== null) {
                this.props.selectProject({project: JSON.parse(projectToken)});
            }
        }
    }
    ...
    onEventIngresar(item) {
        ...
        this.props.selectProject({project: JSON.parse(window.localStorage.getItem('project'))});
    }
...
const mapStateToProps = (state) => {
  ...
  const mapDispatchToProps = { signOut, selectProject }
  
  /**
   *
   * Método encargado de conectar con redux y exportar la clase
   */
  const ConnectedMenu = connect(mapStateToProps, mapDispatchToProps)(Principal);
