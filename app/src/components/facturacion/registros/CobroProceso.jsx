...
class CobroProceso extends React.Component {
    ...
    loadLoteCliente = async (id) => {
        try {
            ...
            const lote = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/lote/lotecliente", {
                signal: this.abortControllerView.signal,
                params: {
                    "idCliente": id
                }
    ...
    loadFillTable = async (idCliente, idConcepto) => {
        try {
            ...
            const cobros = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/cliente/listcobrosasociados", {
                signal: this.abortControllerView.signal,
                params: {
                    "idCliente": idCliente,
