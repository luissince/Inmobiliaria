...
class Dashboard extends React.Component {
    ...
    async loadInit() {
        try {
            ...
            const total = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/dashboard/totales", {
            ...
            const proyecto = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/proyecto/inicio", {
                signal: this.abortControllerView.signal
            });
