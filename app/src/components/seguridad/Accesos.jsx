...
class Accesos extends React.Component {
  ...
  loadDataAcceso = async (id) => {
    try {
      ...
      const accesos = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/acceso/accesos", {
        signal: this.abortControllerView.signal,
        params: {
          idPerfil: id
        }
  ...
  async onEventGuardar() {
    ...
    try {
      ...
      let result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/acceso/save', {
  ...
  async onEventUpdateData() {
    ...
    try {
      ...
      let result = await axios.post(import.meta.env.VITE_APP_END_POINT+'/api/acceso/updatedata', {
        "idPerfil": this.state.idPerfil,
        "menu": this.state.menu
      });
