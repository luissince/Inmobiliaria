...
class Usuarios extends React.Component {
    ...
    fillTable = async (opcion, buscar) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/usuario/list', {
        ...
        ModalAlertDialog("Eliminar Usuario", "¿Está seguro de que desea eliminar el usuario? Esta operación no se puede deshacer.", async (value) => {
            if (value) {
                try {
                    ...
                    let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+'/api/usuario', {
                        params: {
                            "idUsuario": idUsuario
                        }
                    })
    ...
    async onEventReset() {
        ...
        try {
            ...
            let result = await axios.post(import.meta.env.VITE_APP_END_POINT+"/api/usuario/reset", {
