...
class CpeElectronicos extends React.Component {
    ...
    fillTable = async (opcion, buscar, fechaInicio, fechaFinal, idComprobante, idEstado) => {
        try {
            ...
            const result = await axios.get(import.meta.env.VITE_APP_END_POINT+'/api/factura/cpesunat', {
            ...
            ModalAlertDialog("Facturación", "¿Está seguro de enviar el comprobante electrónico?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(`${import.meta.env.VITE_APP_URL}/app/examples/boleta.php`, {
                            params: {
                                "idCobro": idCpeSunat
                            }
                        });
            ...
            ModalAlertDialog("Facturación", "¿Está seguro de enviar el comprobante electrónico?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(`${import.meta.env.VITE_APP_URL}/app/examples/notacredito.php`, {
                            params: {
            ...
            ModalAlertDialog("Email", "¿Está seguro de envíar el email?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/cobro/email", {
                            params: {
                                "idSede": "SD0001",
                                "idCobro": idCpeSunat,
                            }
            ...
            ModalAlertDialog("Email", "¿Está seguro de envíar el email?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/notacredito/email", {
                            params: {
                                "idSede": "SD0001",
                                "idNotaCredito": idCpeSunat,
                            }
            ...
            ModalAlertDialog("Facturación", "¿Está seguro de anular el comprobante electrónico?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(`${import.meta.env.VITE_APP_URL}/app/examples/resumen.php`, {
                            params: {
                                "idCobro": idCpeSunat
                            }
                        });
            ...
            ModalAlertDialog("Facturación", "¿Está seguro de anular el comprobante electrónico?", async (value) => {
                if (value) {
                    try {
                        ...
                        let result = await axios.get(`${import.meta.env.VITE_APP_URL}/app/examples/resumen_nota_credito.php`, {
                            params: {
                                "idNotaCredito": idCpeSunat
                            }
                        });
