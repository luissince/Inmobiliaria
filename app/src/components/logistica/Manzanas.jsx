...
class Manzanas extends React.Component {
  ...
  async loadDataId(id) {
    try {
      let result = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/manzana/id", {
  ...
  onEventGuardar = async () => {
    ...
    try {
      ...
      if (this.state.idManzana === "") {
        const result = await axios.post(import.meta.env.VITE_APP_END_POINT+"/api/manzana/", {
        ...
        const result = await axios.put(import.meta.env.VITE_APP_END_POINT+"/api/manzana", {
      ...
      async (event) => {
        if (event) {
          try {
            ...
            let result = await axios.delete(import.meta.env.VITE_APP_END_POINT+"/api/manzana", {
              params: {
                idManzana: idManzana,
              },
            });
