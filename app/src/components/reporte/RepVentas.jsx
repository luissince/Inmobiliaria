...
class RepVentas extends React.Component {
    ...
    loadData = async () => {
        try {
            ...
            const cliente = await axios.get(import.meta.env.VITE_APP_END_POINT+"/api/cliente/listcombo", {
    ...
    async onEventImprimir() {
        ...
        window.open(import.meta.env.VITE_APP_END_POINT+"/api/factura/repgeneralventas?" + params, "_blank");
    }
